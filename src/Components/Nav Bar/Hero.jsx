  ...
  return (
    <div className='text-white '>
      <div className='max-w-[800px] w-full h-screen mt-[-96px] mx-auto items-center flex flex-col justify-center'>
        <p className='uppercase text-primary font-bold p-2'>Practicing Frontend Devlopment</p>
      ...
      <button className='bg-secondary font-bold py-2 px-6 rounded-full text-black mt-4'>Do Practice</button>
